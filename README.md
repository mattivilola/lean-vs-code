...
The first release supports **Apple Silicon Macs**. Download the signed and notarized [v0.2.0 DMG](https://github.com/mattivilola/lean-vs-code/releases/tag/v0.2.0), open it, and drag **Lean VS Code** into **Applications**. Launch it from Applications and open a file or folder. It does not replace your existing VS Code installation or import its extensions automatically. There is no automatic app updater in v0.2.0; use the [Releases page](https://github.com/mattivilola/lean-vs-code/releases) for later versions.
