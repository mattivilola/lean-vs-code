...
- 33 curated built-in extensions for syntax, themes, and Git; optional extensions are available through Open VSX or a local VSIX. Signed Open VSX packages are checked against its pinned Ed25519 public key.
